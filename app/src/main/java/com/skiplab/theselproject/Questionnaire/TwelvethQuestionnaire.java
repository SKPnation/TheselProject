 ...
 */
public class TwelvethQuestionnaire extends Fragment {

    Button goodBtn, fairBtn, poorBtn;

    public TwelvethQuestionnaire() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_twelveth_questionnaire, container, false);
        ...
        goodBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Bundle b = new Bundle();
                b.putString("sleeping_habits", goodBtn.getText().toString());
        ...
        fairBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Bundle b = new Bundle();
                b.putString("sleeping_habits", fairBtn.getText().toString());
        ...
        poorBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Bundle b = new Bundle();
                b.putString("sleeping_habits", poorBtn.getText().toString());
